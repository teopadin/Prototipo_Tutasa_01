    ...
    internal class ModeloGenerarHDRDistribucion
    {
        ...
        public ModeloGenerarHDRDistribucion()
        {
            ...
            var guiasEnOrdenDeLlegada = new List<Guia>
            {
                ...
                new Guia { NroGuia = "CD03-0001", fechaImposicion = new DateTime(2026, 5, 20), ModalidadEntrega = ModalidadEntregaEnum.EntregaDomicilio, Estado = EstadoGuiaEnum.EnCDDestino, idCDOrigen = cdNorte, idCDDestino = cdCapital, Destinatario = dest1, idAgenciaDestino = null },

                // Puerta a puerta, origen CD Centro, destino Capital - misma dirección que CD03-0001 para probar filtro
                new Guia { NroGuia = "CD02-0001", fechaImposicion = new DateTime(2026, 5, 21), ModalidadEntrega = ModalidadEntregaEnum.EntregaDomicilio, Estado = EstadoGuiaEnum.EnCDDestino, idCDOrigen = cdCentro, idCDDestino = cdCapital, Destinatario = dest2, idAgenciaDestino = null },

                // Retiro en agencia, origen Agencia 1, destino Capital
                new Guia { NroGuia = "A001-0001", fechaImposicion = new DateTime(2026, 5, 22), ModalidadEntrega = ModalidadEntregaEnum.EntregaAgencia, Estado = EstadoGuiaEnum.EnCDDestino, idCDOrigen = cdNorte, idCDDestino = cdCapital, Destinatario = null, idAgenciaDestino = agencia1 },

                // Retiro en agencia, origen Agencia 2, destino Capital
                new Guia { NroGuia = "A002-0001", fechaImposicion = new DateTime(2026, 5, 23), ModalidadEntrega = ModalidadEntregaEnum.EntregaAgencia, Estado = EstadoGuiaEnum.EnCDDestino, idCDOrigen = cdNorte, idCDDestino = cdCapital, Destinatario = null, idAgenciaDestino = agencia2 },

                // Retiro en agencia, origen Agencia 1, destino Capital
                new Guia { NroGuia = "A001-0002", fechaImposicion = new DateTime(2026, 5, 24), ModalidadEntrega = ModalidadEntregaEnum.EntregaAgencia, Estado = EstadoGuiaEnum.EnCDDestino, idCDOrigen = cdNorte, idCDDestino = cdCapital, Destinatario = null, idAgenciaDestino = agencia1 },

                // Puerta a puerta, destino Córdoba - NO debe aparecer (CD destino != CD emisor)
                new Guia { NroGuia = "CD01-0001", fechaImposicion = new DateTime(2026, 5, 22), ModalidadEntrega = ModalidadEntregaEnum.EntregaDomicilio, Estado = EstadoGuiaEnum.EnCDDestino, idCDOrigen = cdCapital, idCDDestino = cdCentro, Destinatario = dest3, idAgenciaDestino = null },

                // En distribución - NO debe aparecer (estado incorrecto)
                new Guia { NroGuia = "CD03-0002", fechaImposicion = new DateTime(2026, 5, 19), ModalidadEntrega = ModalidadEntregaEnum.EntregaDomicilio, Estado = EstadoGuiaEnum.EnDistribucion, idCDOrigen = cdNorte, idCDDestino = cdCapital, Destinatario = dest1, idAgenciaDestino = null },

                new Guia { NroGuia = "CD01-0002", fechaImposicion = new DateTime(2026, 5, 25), ModalidadEntrega = ModalidadEntregaEnum.EntregaDomicilio, Estado = EstadoGuiaEnum.Admitida, idCDOrigen = cdCapital, idCDDestino = cdCapital, Destinatario = dest1, idAgenciaDestino = null },
            };
