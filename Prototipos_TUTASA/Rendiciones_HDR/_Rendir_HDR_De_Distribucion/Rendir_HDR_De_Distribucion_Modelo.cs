...
namespace Prototipos_TUTASA.Rendiciones_HDR._Rendir_HDR_De_Distribucion
{
    internal class Rendir_HDR_De_Distribucion_Modelo
    {
        ...
        internal List<MotivoNoCumplida> ObtenerMotivos()
        {
            return new List<MotivoNoCumplida>
            {
                MotivoNoCumplida.DestinatarioAusente,
                MotivoNoCumplida.DireccionIncorrecta,
                MotivoNoCumplida.AgenciaCerrada,
                MotivoNoCumplida.RechazoDeEncomienda
            };
        }

        internal bool AplicarEstado(HDRDistribucion hdr, bool cumplida, MotivoNoCumplida? motivo)
        {
            // Validaciones
