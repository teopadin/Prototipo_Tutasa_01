...
namespace Prototipos_TUTASA.Rendiciones_HDR._Rendir_HDR_De_Distribucion
{
    ...
    {
        new HojaDeRutaDistribucion { NroHDR = 1001, DniTransportistaAsignado = 11111111, Destinatario = "Juan Garcia",      Calle = "Av. Corrientes", Altura = 1234, Piso = "1",  CP = "1043", Estado = EstadoHojaDeRutaEnum.EnCurso,  DetalleGuias = new List<string> { "G-D-001" } },
        new HojaDeRutaDistribucion { NroHDR = 1002, DniTransportistaAsignado = 11111111, Destinatario = "Maria Lopez",      Calle = "Lavalle",        Altura = 567,  Piso = "3",  CP = "1047", Estado = EstadoHojaDeRutaEnum.EnCurso,  DetalleGuias = new List<string> { "G-D-002" } },
        new HojaDeRutaDistribucion { NroHDR = 1003, DniTransportistaAsignado = 11111111, Destinatario = "Pedro Ramirez",    Calle = "Florida",        Altura = 890,  Piso = "PB", CP = "1005", Estado = EstadoHojaDeRutaEnum.Recibida, DetalleGuias = new List<string> { "G-D-003" } },
        new HojaDeRutaDistribucion { NroHDR = 1004, DniTransportistaAsignado = 22222222, Destinatario = "Ana Martinez",     Calle = "Santa Fe",       Altura = 2345, Piso = "2",  CP = "1123", Estado = EstadoHojaDeRutaEnum.EnCurso,  DetalleGuias = new List<string> { "G-D-004" } },
        new HojaDeRutaDistribucion { NroHDR = 1005, DniTransportistaAsignado = 22222222, Destinatario = "Carlos Sosa",      Calle = "Cordoba",        Altura = 678,  Piso = "4",  CP = "1054", Estado = EstadoHojaDeRutaEnum.Recibida, DetalleGuias = new List<string> { "G-D-005" } },
        new HojaDeRutaDistribucion { NroHDR = 1006, DniTransportistaAsignado = 33333333, Destinatario = "Laura Diaz",       Calle = "Rivadavia",      Altura = 4567, Piso = "5",  CP = "1407", Estado = EstadoHojaDeRutaEnum.EnCurso,  DetalleGuias = new List<string> { "G-D-006" } },
        new HojaDeRutaDistribucion { NroHDR = 1007, DniTransportistaAsignado = 33333333, Destinatario = "Roberto Gomez",    Calle = "Belgrano",       Altura = 1100, Piso = "PB", CP = "1092", Estado = EstadoHojaDeRutaEnum.EnCurso,  DetalleGuias = new List<string> { "G-D-007" } },
        new HojaDeRutaDistribucion { NroHDR = 1008, DniTransportistaAsignado = 33333333, Destinatario = "Sofia Fernandez",  Calle = "Callao",         Altura = 230,  Piso = "1",  CP = "1022", Estado = EstadoHojaDeRutaEnum.Recibida, DetalleGuias = new List<string> { "G-D-008" } },
        new HojaDeRutaDistribucion { NroHDR = 1009, DniTransportistaAsignado = 33333333, Destinatario = "Diego Castro",     Calle = "Pueyrredon",     Altura = 1500, Piso = "3",  CP = "1118", Estado = EstadoHojaDeRutaEnum.EnCurso,  DetalleGuias = new List<string> { "G-D-009" } },
        new HojaDeRutaDistribucion { NroHDR = 1010, DniTransportistaAsignado = 44444444, Destinatario = "Patricia Vega",    Calle = "Scalabrini",     Altura = 980,  Piso = "PB", CP = "1414", Estado = EstadoHojaDeRutaEnum.EnCurso,  DetalleGuias = new List<string> { "G-D-010" } }
    };
